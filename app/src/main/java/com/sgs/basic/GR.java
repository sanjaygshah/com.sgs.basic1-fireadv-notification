...
import static com.sgs.basic.Run.EventHolder.*;
...
//	public static double TouchY[] = {0,0};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//drawView.setId(34);
		drawView.setId(drawView.generateViewId());
		//setContentView(drawView);
		mAdView = new AdView(this);
		mAdView.setAdSize(AdSize.SMART_BANNER);
		//mAdView = (AdView) findViewById(R.id.adView);
		mAdView.setAdUnitId("ca-app-pub-2141884049047574/6548610840");

		//Ad unit ID: ca-app-pub-2141884049047574/6548610840
		...
		//adRequest.addTestDevice(AdRequest.TEST_EMULATOR);	// remove this after testing
